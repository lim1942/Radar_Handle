...
function TRS_Document_Content(urlname,urltitle,content){
    ...
    // for urltitle
        match_1 = content.match(/<!--<\$\[标题\]>begin-->([\s\S]*?)<!--<\$\[标题\]>end-->/)
    ...
    // for srcname
        match_3 = content.match(/<!--<\$\[信息来源\]>begin-->([\s\S]*?)<!--<\$\[信息来源\]>end-->/)
    ...
    // for urltime
        match_5 = content.match(/发布日期[：:]([\s\S]*?)</)
    ...
    // for vreserved2
        match_7 = content.match(/<!--<\$\[副标题\]>begin-->([\s\S]*?)<!--<\$\[副标题\]>end-->/)
